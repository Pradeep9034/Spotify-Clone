...
const SearchPage=()=>{
    const [isInputFoucused,setIsInputFocused]=useState(false);
    ...
    return (
        <LoggedInContainer curActiveScreen="search">
            <div className="w-full py-6">
                <div className={`w-1/3 p-3 text-sm rounded-full bg-gray-800 px-5 text-white flex space-x-3 items-center ${isInputFoucused ? "border-border-white":""}`}>
                ...
                </div>
                {
                    ...
                    <div className="text-white pt-10 text-gray-500">
