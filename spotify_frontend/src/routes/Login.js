    ...
    return(
        <div className="w-full h-full flex flex-col items-center">
            ...
            <div className="inputRegion w-1/3 py-10 flex items-center justify-center flex-col">
                ...
                <div className='border border-gray-500 text-gray-500 w-full flex flex-center justify-center py-4 rounded-full font-bold'><Link to="/signup">SIGN UP FOR SPOTIFY</Link></div>
            </div>
