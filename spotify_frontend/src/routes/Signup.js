...
const signUp= async()=>{
    ...
    if(response && !response.error){
        ...
        alert("A user with this email is already exist");
}
    ...
    return(
        <div className="w-full h-full flex flex-col items-center">
            ...
            <div className="inputRegion w-1/3 py-10 flex items-center justify-center flex-col">
                ...
                <TextInput label="Email address" placeholder="Enter your email" className="my-6" value={email} setValue={setEmail}/>
                ...
                <PasswordInput label=" Create Password" placeholder=" Enter a strong password here" className="my-6" value={password} setValue={setPassword}/>
                ...
                <div className='my-5 w-full border border-solid border-gray-300'></div>
                <div className='my-6 font-semibold text-lg'>
                    Already have an account?
                </div>

                <div className='border border-gray-500 text-gray-500 w-full flex flex-center justify-center py-4 rounded-full font-bold'><Link to="/login">LOG IN INSTEAD</Link></div>
            </div>
