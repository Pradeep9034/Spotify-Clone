...
//route 2 to get the playlist by ID
...
router.post("/add/song",passport.authenticate("jwt",{session:false}),async (req,res)=>{
    ...
    //step 1-check if the current user owns the playlist or is a collaborator
    ...
    //step 3- we can simply now add the song to the playlist
